...
# (b) DiGIT
ax2.errorbar(range(N), central_offsets, yerr=central_std, fmt='o', ecolor='blue', capsize=3, markersize=4, color='blue', label='Central-Region Cross-Attention')
ax2.errorbar(range(N), adjacent_offsets, yerr=adjacent_std, fmt='o', ecolor='red', capsize=3, markersize=4, color='red', label='Adjacent-Region Cross-Attention')
ax2.set_xlim(-1, N)
