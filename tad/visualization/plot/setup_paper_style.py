    ...
    plt.rcParams.update(
        {
            ...
            "xtick.major.size": 4 * 0.35 * line_width_axis,
            "xtick.major.width": 0.35 * line_width_axis,
            "xtick.major.pad": 0.15 * font_size_main,
            "ytick.labelsize": font_size_main,
            "ytick.major.size": 4 * 0.35 * line_width_axis,
            "ytick.major.width": 0.35 * line_width_axis,
